...
def open_app(text):
    ...
    if "google" in text:
        ...
        speak("Pycharm  đã mở, bạn muốn loli làm gì nữa !")
...
def music_google():
    ...
    if ("rap" in a) or ("đọc rap" in a):
        mixer.init()
        mixer.music.load(r"D:\Học tập\Đồ án\DoAnCN\rap1.mp3")  # Music file can only be MP3
        mixer.music.play()
        ...
        mixer.init()
        mixer.music.load(r"D:\Học tập\Đồ án\DoAnCN\sn1.mp3")  # Music file can only be MP3
        mixer.music.play()
        # Then start a infinite loop
        time.sleep(15)
        speak("Bạn muốn loli làm gì nữa không ")
        ...
        mixer.init()
        mixer.music.load(r"D:\Học tập\Đồ án\DoAnCN\nono.mp3")  # Music file can only be MP3
        mixer.music.play()
        time.sleep(13)
        speak("Bạn muốn loli làm gì nữa không ")
